...
AMI_ID = "ami-05054829dd1f8a5f9" 
INSTANCE_TYPE = "t2.micro"
MAX_INSTANCES = 15
SECURITY_GROUP = ['sg-0e10b1e6f767bdc3e']
SUBNET_ID = 'subnet-005c0366f373a16b8' 
KEY_NAME = 'p1p1'

SQS_REQUEST = "https://sqs.us-east-1.amazonaws.com/253490793660/-req-queue"
SQS_RESPONSE = "https://sqs.us-east-1.amazonaws.com/253490793660/-resp-queue"
EC2_Tag = "app-tier"
...
def determine_instance_count(message_count):
    ...
    if message_count >= 50:
        return 15  # Cap at 20 instances
    elif 10 <= message_count < 50:
        return min(15, message_count)  # Gradually scale to 20 instances
...
def autoscale(sqs, ec2):
    ...
    print(running_instances,existing_numbers)
    req_count = get_message_count(sqs, SQS_REQUEST)
    ...
    try:
        max_needed_instances = max(req_instances, max_needed_instances)
    except NameError:
    ...
    elif req_instances < current_instance_count or req_count == 0:
        terminate_instances(ec2, current_instance_count - req_instances, existing_numbers, sqs)


if __name__ == "__main__":
    # Initialize Boto3 clients
    ec2 = boto3.client("ec2", region_name=AWS_REGION,aws_access_key_id=AWS_Access_Key,aws_secret_access_key=AWS_Secret_Access_key)
